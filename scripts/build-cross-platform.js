...
async function downloadLargeAssetsIfCI(ext) {
  ...
  const videoBgUrl = "https://socket.breakeventx.com/updates/beta/video-bg.mp4";
  ...
  const templateUrl = `https://socket.breakeventx.com/updates/beta/dashboard_dist/${osTag}/${ext}_BreakEvenClient_Template.zip`;
